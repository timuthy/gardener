...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*HugePageConfiguration)(nil), (*core.HugePageConfiguration)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1beta1_HugePageConfiguration_To_core_HugePageConfiguration(a.(*HugePageConfiguration), b.(*core.HugePageConfiguration), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*core.HugePageConfiguration)(nil), (*HugePageConfiguration)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_core_HugePageConfiguration_To_v1beta1_HugePageConfiguration(a.(*core.HugePageConfiguration), b.(*HugePageConfiguration), scope)
	}); err != nil {
		return err
	}
	...
	if err := s.AddGeneratedConversionFunc((*WorkerMemoryConfiguration)(nil), (*core.WorkerMemoryConfiguration)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1beta1_WorkerMemoryConfiguration_To_core_WorkerMemoryConfiguration(a.(*WorkerMemoryConfiguration), b.(*core.WorkerMemoryConfiguration), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*core.WorkerMemoryConfiguration)(nil), (*WorkerMemoryConfiguration)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_core_WorkerMemoryConfiguration_To_v1beta1_WorkerMemoryConfiguration(a.(*core.WorkerMemoryConfiguration), b.(*WorkerMemoryConfiguration), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1beta1_HugePageConfiguration_To_core_HugePageConfiguration(in *HugePageConfiguration, out *core.HugePageConfiguration, s conversion.Scope) error {
	out.PageSize = in.PageSize
	out.Quantity = in.Quantity
	return nil
}

// Convert_v1beta1_HugePageConfiguration_To_core_HugePageConfiguration is an autogenerated conversion function.
func Convert_v1beta1_HugePageConfiguration_To_core_HugePageConfiguration(in *HugePageConfiguration, out *core.HugePageConfiguration, s conversion.Scope) error {
	return autoConvert_v1beta1_HugePageConfiguration_To_core_HugePageConfiguration(in, out, s)
}

func autoConvert_core_HugePageConfiguration_To_v1beta1_HugePageConfiguration(in *core.HugePageConfiguration, out *HugePageConfiguration, s conversion.Scope) error {
	out.PageSize = in.PageSize
	out.Quantity = in.Quantity
	return nil
}

// Convert_core_HugePageConfiguration_To_v1beta1_HugePageConfiguration is an autogenerated conversion function.
func Convert_core_HugePageConfiguration_To_v1beta1_HugePageConfiguration(in *core.HugePageConfiguration, out *HugePageConfiguration, s conversion.Scope) error {
	return autoConvert_core_HugePageConfiguration_To_v1beta1_HugePageConfiguration(in, out, s)
}
...
func autoConvert_v1beta1_Worker_To_core_Worker(in *Worker, out *core.Worker, s conversion.Scope) error {
	...
	out.MemoryConfiguration = (*core.WorkerMemoryConfiguration)(unsafe.Pointer(in.MemoryConfiguration))
	return nil
}
...
func autoConvert_core_Worker_To_v1beta1_Worker(in *core.Worker, out *Worker, s conversion.Scope) error {
	...
	out.MemoryConfiguration = (*WorkerMemoryConfiguration)(unsafe.Pointer(in.MemoryConfiguration))
	return nil
}
...
func autoConvert_v1beta1_WorkerMemoryConfiguration_To_core_WorkerMemoryConfiguration(in *WorkerMemoryConfiguration, out *core.WorkerMemoryConfiguration, s conversion.Scope) error {
	out.HugePages = *(*[]core.HugePageConfiguration)(unsafe.Pointer(&in.HugePages))
	return nil
}

// Convert_v1beta1_WorkerMemoryConfiguration_To_core_WorkerMemoryConfiguration is an autogenerated conversion function.
func Convert_v1beta1_WorkerMemoryConfiguration_To_core_WorkerMemoryConfiguration(in *WorkerMemoryConfiguration, out *core.WorkerMemoryConfiguration, s conversion.Scope) error {
	return autoConvert_v1beta1_WorkerMemoryConfiguration_To_core_WorkerMemoryConfiguration(in, out, s)
}

func autoConvert_core_WorkerMemoryConfiguration_To_v1beta1_WorkerMemoryConfiguration(in *core.WorkerMemoryConfiguration, out *WorkerMemoryConfiguration, s conversion.Scope) error {
	out.HugePages = *(*[]HugePageConfiguration)(unsafe.Pointer(&in.HugePages))
	return nil
}

// Convert_core_WorkerMemoryConfiguration_To_v1beta1_WorkerMemoryConfiguration is an autogenerated conversion function.
func Convert_core_WorkerMemoryConfiguration_To_v1beta1_WorkerMemoryConfiguration(in *core.WorkerMemoryConfiguration, out *WorkerMemoryConfiguration, s conversion.Scope) error {
	return autoConvert_core_WorkerMemoryConfiguration_To_v1beta1_WorkerMemoryConfiguration(in, out, s)
}
