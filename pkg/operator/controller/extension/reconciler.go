...
func (r *Reconciler) Reconcile(ctx context.Context, request reconcile.Request) (reconcile.Result, error) {
	...
	if garden.reconciled || (garden.deleting && garden.garden != nil) {
		var err error
...
func gardenInDeletion(garden *operatorv1alpha1.Garden) bool {
	return garden.DeletionTimestamp != nil && garden.Status.LastOperation != nil && garden.Status.LastOperation.Type == gardencorev1beta1.LastOperationTypeDelete
}
