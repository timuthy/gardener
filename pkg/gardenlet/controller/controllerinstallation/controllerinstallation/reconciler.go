...
func (r *Reconciler) reconcile(
	...
	if err := gardenerutils.MutateObjectsInSecretData(
		...
		func(obj runtime.Object) error {
			return gardenerutils.InjectGenericGardenKubeconfig(obj, genericGardenKubeconfigSecretName, gardenerutils.VolumeMountPathGenericGardenKubeconfig, gardenAccessSecret.Secret.Name)
		},
		// Set seed name
		func(obj runtime.Object) error {
