	...
	controllerArtifact = addOptions{
		...
		options: []controllerOptions{
			...
			},
			{
				...
				reconciler:          stateControl.createShootStateSyncReconcileFunc(ctx, extensionsv1alpha1.BackupEntryResource, func() runtime.Object { return &extensionsv1alpha1.BackupEntry{} }),
	...
	controllerArtifact = addOptions{
		...
		options: []controllerOptions{
			...
			},
			{
				...
				concurrentReconcile: shootStateWorkers,
				reconciler:          stateControl.createShootStateSyncReconcileFunc(ctx, extensionsv1alpha1.ContainerRuntimeResource, func() runtime.Object { return &extensionsv1alpha1.ContainerRuntime{} }),
				updateFunc:          extensionStateOrResourcesChanged,
			},
		},
	}
	...
	controllerArtifact = addOptions{
		...
		options: []controllerOptions{
			...
			},
			{
				...
				concurrentReconcile: shootStateWorkers,
				reconciler:          stateControl.createShootStateSyncReconcileFunc(ctx, extensionsv1alpha1.ControlPlaneResource, func() runtime.Object { return &extensionsv1alpha1.ControlPlane{} }),
				updateFunc:          extensionStateOrResourcesChanged,
			},
		},
	}
	...
	controllerArtifact = addOptions{
		...
		options: []controllerOptions{
			...
			},
			{
				...
				concurrentReconcile: shootStateWorkers,
				reconciler:          stateControl.createShootStateSyncReconcileFunc(ctx, extensionsv1alpha1.ExtensionResource, func() runtime.Object { return &extensionsv1alpha1.Extension{} }),
				updateFunc:          extensionStateOrResourcesChanged,
			},
		},
	}
	...
	controllerArtifact = addOptions{
		...
		options: []controllerOptions{
			...
			},
			{
				...
				concurrentReconcile: shootStateWorkers,
				reconciler:          stateControl.createShootStateSyncReconcileFunc(ctx, extensionsv1alpha1.InfrastructureResource, func() runtime.Object { return &extensionsv1alpha1.Infrastructure{} }),
				updateFunc:          extensionStateOrResourcesChanged,
			},
		},
	}
	...
	controllerArtifact = addOptions{
		...
		options: []controllerOptions{
			...
			},
			{
				...
				concurrentReconcile: shootStateWorkers,
				reconciler:          stateControl.createShootStateSyncReconcileFunc(ctx, extensionsv1alpha1.NetworkResource, func() runtime.Object { return &extensionsv1alpha1.Network{} }),
				updateFunc:          extensionStateOrResourcesChanged,
			},
		},
	}
	...
	controllerArtifact = addOptions{
		...
		options: []controllerOptions{
			...
			},
			{
				...
				concurrentReconcile: shootStateWorkers,
				reconciler:          stateControl.createShootStateSyncReconcileFunc(ctx, extensionsv1alpha1.OperatingSystemConfigResource, func() runtime.Object { return &extensionsv1alpha1.OperatingSystemConfig{} }),
				updateFunc:          extensionStateOrResourcesChanged,
			},
		},
	}
	...
	controllerArtifact = addOptions{
		...
		options: []controllerOptions{
			...
			},
			{
				...
				concurrentReconcile: shootStateWorkers,
				reconciler:          stateControl.createShootStateSyncReconcileFunc(ctx, extensionsv1alpha1.WorkerResource, func() runtime.Object { return &extensionsv1alpha1.Worker{} }),
				updateFunc:          extensionStateOrResourcesChanged,
			},
		},
	}
